...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        //2.创建Path 路径实例
        String dfsPath = "hdfs://192.168.3.7:8020/input/";//设置文件目录路径
        ...
        fs.copyFromLocalFile(false, true, new Path("d://log.txt"), file);
        //将HDFS上dfspath指定目录下的文件复制到了本地
        fs.copyToLocalFile(false, file, new Path("d://"), true);

        //文件重命名，成功返回true
        boolean bn = fs.rename(file, new Path("hdfs://192.168.3.7:8020/input/renamelog.txt"));
